/******************************************************************************
 * @file        xHal_Rpi5CarSpeakerSimulationArguments.cpp
 * @brief       Implements persistent Speaker trace argument parsing.
...
{
    XWalkSpeakerSimulationArguments::XWalkSpeakerSimulationArguments(int32 argumentCount, charpointer argumentValues[])
    ...
    XWalkSpeakerSimulationArguments::~XWalkSpeakerSimulationArguments() = default;
    boolean XWalkSpeakerSimulationArguments::valid() const noexcept
    {
        return validValue;
    }
    boolean XWalkSpeakerSimulationArguments::helpRequested() const noexcept
    {
        return helpRequestedValue;
    }
    boolean XWalkSpeakerSimulationArguments::applyTraceUpdate() const
    {
    ...
    boolean XWalkSpeakerSimulationArguments::targetIsValid(stringview target) noexcept
    {
    ...
    void XWalkSpeakerSimulationArguments::parseSelector(stringview selector)
    {

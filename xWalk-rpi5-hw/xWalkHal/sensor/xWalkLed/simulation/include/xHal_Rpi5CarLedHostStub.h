/******************************************************************************
 * @file        xHal_Rpi5CarLedHostStub.h
 * @brief       Declares the device-free LED GPIO and I2C host stub.
 ...
 ******************************************************************************/
#ifndef XHAL_RPI5CAR_LED_HOST_STUB_H
#define XHAL_RPI5CAR_LED_HOST_STUB_H
#include "xHal_Rpi5CarLed.h"
namespace xwalk::hal::sim
{
    /** @brief Records in-memory LED GPIO state and RGB PWM I2C writes. */
    class XWalkLedHostStub final
    {
        private:
...
#endif /* XHAL_RPI5CAR_LED_HOST_STUB_H */

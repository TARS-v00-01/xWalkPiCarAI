/******************************************************************************
 * @file        xHal_Rpi5CarLedSimulationArguments.cpp
 * @brief       Implements persistent LED trace argument parsing.
...
{
    XWalkLedSimulationArguments::XWalkLedSimulationArguments(int32 argumentCount, charpointer argumentValues[])
    ...
    XWalkLedSimulationArguments::~XWalkLedSimulationArguments() = default;
    boolean XWalkLedSimulationArguments::valid() const noexcept
    {
        return validValue;
    }
    boolean XWalkLedSimulationArguments::helpRequested() const noexcept
    {
        return helpRequestedValue;
    }
    boolean XWalkLedSimulationArguments::applyTraceUpdate() const
    {
    ...
    boolean XWalkLedSimulationArguments::targetIsValid(stringview target) noexcept
    {
    ...
    void XWalkLedSimulationArguments::parseSelector(stringview selector)
    {

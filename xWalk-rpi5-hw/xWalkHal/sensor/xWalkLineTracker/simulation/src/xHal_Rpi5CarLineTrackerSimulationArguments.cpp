/******************************************************************************
 * @file        xHal_Rpi5CarLineTrackerSimulationArguments.cpp
 * @brief       Implements persistent LineTracker trace argument parsing.
...
{
    XWalkLineTrackerSimulationArguments::XWalkLineTrackerSimulationArguments(int32 argumentCount,
    ...
    XWalkLineTrackerSimulationArguments::~XWalkLineTrackerSimulationArguments() = default;
    boolean XWalkLineTrackerSimulationArguments::valid() const noexcept
    {
        return validValue;
    }
    boolean XWalkLineTrackerSimulationArguments::helpRequested() const noexcept
    {
        return helpRequestedValue;
    }
    boolean XWalkLineTrackerSimulationArguments::applyTraceUpdate() const
    {
    ...
    boolean XWalkLineTrackerSimulationArguments::targetIsValid(stringview target) noexcept
    {
    ...
    void XWalkLineTrackerSimulationArguments::parseSelector(stringview selector)
    {

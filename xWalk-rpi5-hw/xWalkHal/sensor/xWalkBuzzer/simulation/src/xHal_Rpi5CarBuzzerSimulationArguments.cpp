/******************************************************************************
 * @file        xHal_Rpi5CarBuzzerSimulationArguments.cpp
 * @brief       Implements persistent Buzzer trace argument parsing.
...
{
    XWalkBuzzerSimulationArguments::XWalkBuzzerSimulationArguments(int32 argumentCount, charpointer argumentValues[])
    ...
    XWalkBuzzerSimulationArguments::~XWalkBuzzerSimulationArguments() = default;
    boolean XWalkBuzzerSimulationArguments::valid() const noexcept
    {
        return validValue;
    }
    boolean XWalkBuzzerSimulationArguments::helpRequested() const noexcept
    {
        return helpRequestedValue;
    }
    boolean XWalkBuzzerSimulationArguments::applyTraceUpdate() const
    {
    ...
    boolean XWalkBuzzerSimulationArguments::targetIsValid(stringview target) noexcept
    {
    ...
    void XWalkBuzzerSimulationArguments::parseSelector(stringview selector)
    {

/******************************************************************************
 * @file        xHal_Rpi5CarUltrasonicSimulationArguments.cpp
 * @brief       Implements persistent ultrasonic trace argument parsing.
...
{
    XWalkUltrasonicSimulationArguments::XWalkUltrasonicSimulationArguments(int32 argumentCount,
    ...
    XWalkUltrasonicSimulationArguments::~XWalkUltrasonicSimulationArguments() = default;
    boolean XWalkUltrasonicSimulationArguments::valid() const noexcept
    {
        return validValue;
    }
    boolean XWalkUltrasonicSimulationArguments::helpRequested() const noexcept
    {
        return helpRequestedValue;
    }

    boolean XWalkUltrasonicSimulationArguments::applyTraceUpdate() const
    {
    ...
    boolean XWalkUltrasonicSimulationArguments::targetIsValid(stringview target) noexcept
    {
    ...
    void XWalkUltrasonicSimulationArguments::parseSelector(stringview selector)
    {

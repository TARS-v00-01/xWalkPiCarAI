/******************************************************************************
 * @file        xHal_Rpi5CarAdxl345SimulationArguments.cpp
 * @brief       Implements persistent xWalkAdxl345 trace argument parsing.
...
{
    XWalkAdxl345SimulationArguments::XWalkAdxl345SimulationArguments(int32 argumentCount, charpointer argumentValues[])
    ...
    XWalkAdxl345SimulationArguments::~XWalkAdxl345SimulationArguments() = default;
    boolean XWalkAdxl345SimulationArguments::valid() const noexcept
    {
        return validValue;
    }
    boolean XWalkAdxl345SimulationArguments::helpRequested() const noexcept
    {
        return helpRequestedValue;
    }

    boolean XWalkAdxl345SimulationArguments::applyTraceUpdate() const
    {
    ...
    boolean XWalkAdxl345SimulationArguments::targetIsValid(stringview target) noexcept
    {
    ...
    void XWalkAdxl345SimulationArguments::parseSelector(stringview selector)
    {

#!/usr/bin/env python3
"""Validate and merge the persistent trace catalogue for xWalkAdxl345."""
...
MODULE_SOURCE_PREFIX = "xWalkHal/device/xWalkAdxl345/"
...
def generateConfiguration(input_path: Path, output_path: Path) -> int:
    ...
    if trace_count == 0:
        raise RuntimeError("The trace inventory contains no xWalkAdxl345 traces")
...
def main() -> int:
    ...
    print(f"Validated {trace_count} persistent xWalkAdxl345 trace(s)")
    return 0

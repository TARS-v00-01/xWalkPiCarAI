/******************************************************************************
 * @file        xHal_Rpi5CarAdcSimulationArguments.cpp
 * @brief       Implements persistent xWalkAdc trace argument parsing.
...
{
    XWalkAdcSimulationArguments::XWalkAdcSimulationArguments(int32 argumentCount, charpointer argumentValues[])
    ...
    XWalkAdcSimulationArguments::~XWalkAdcSimulationArguments() = default;
    boolean XWalkAdcSimulationArguments::valid() const noexcept
    {
        return validValue;
    }
    boolean XWalkAdcSimulationArguments::helpRequested() const noexcept
    {
        return helpRequestedValue;
    }

    boolean XWalkAdcSimulationArguments::applyTraceUpdate() const
    {
    ...
    boolean XWalkAdcSimulationArguments::targetIsValid(stringview target) noexcept
    {
    ...
    void XWalkAdcSimulationArguments::parseSelector(stringview selector)
    {

/******************************************************************************
 * @file        xHal_Rpi5CarServoSimulationArguments.cpp
 * @brief       Implements persistent xWalkServo trace argument parsing.
...
{
    XWalkServoSimulationArguments::XWalkServoSimulationArguments(int32 argumentCount, charpointer argumentValues[])
    ...
    XWalkServoSimulationArguments::~XWalkServoSimulationArguments() = default;
    boolean XWalkServoSimulationArguments::valid() const noexcept
    {
        return validValue;
    }
    boolean XWalkServoSimulationArguments::helpRequested() const noexcept
    {
        return helpRequestedValue;
    }

    boolean XWalkServoSimulationArguments::applyTraceUpdate() const
    {
    ...
    boolean XWalkServoSimulationArguments::targetIsValid(stringview target) noexcept
    {
    ...
    void XWalkServoSimulationArguments::parseSelector(stringview selector)
    {

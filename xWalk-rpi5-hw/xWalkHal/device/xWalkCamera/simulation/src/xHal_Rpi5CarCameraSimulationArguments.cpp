/******************************************************************************
 * @file        xHal_Rpi5CarCameraSimulationArguments.cpp
 * @brief       Implements persistent xWalkCamera trace argument parsing.
...
{
    XWalkCameraSimulationArguments::XWalkCameraSimulationArguments(int32 argumentCount, charpointer argumentValues[])
    ...
    XWalkCameraSimulationArguments::~XWalkCameraSimulationArguments() = default;
    boolean XWalkCameraSimulationArguments::valid() const noexcept
    {
        return validValue;
    }
    boolean XWalkCameraSimulationArguments::helpRequested() const noexcept
    {
        return helpRequestedValue;
    }

    boolean XWalkCameraSimulationArguments::applyTraceUpdate() const
    {
    ...
    boolean XWalkCameraSimulationArguments::targetIsValid(stringview target) noexcept
    {
    ...
    void XWalkCameraSimulationArguments::parseSelector(stringview selector)
    {

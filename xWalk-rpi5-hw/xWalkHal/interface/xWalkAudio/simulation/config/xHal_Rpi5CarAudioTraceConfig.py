#!/usr/bin/env python3
"""Validate and merge the persistent trace catalogue for xWalkAudio."""
...
MODULE_SOURCE_PREFIX = "xWalkHal/interface/xWalkAudio/"
...
def generateConfiguration(input_path: Path, output_path: Path) -> int:
    ...
    if trace_count == 0:
        raise RuntimeError("The trace inventory contains no xWalkAudio traces")
...
def main() -> int:
    ...
    print(f"Validated {trace_count} persistent xWalkAudio trace(s)")
    return 0

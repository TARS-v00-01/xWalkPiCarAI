#!/usr/bin/env python3
"""Validate and merge the persistent trace catalogue for xWalkI2c."""
...
MODULE_SOURCE_PREFIX = "xWalkHal/interface/xWalkI2c/"
...
def main() -> int:
    ...
    print(f"Validated {trace_count} persistent xWalkI2c trace(s)")
    return 0

#!/usr/bin/env python3
"""Validate and merge the persistent trace catalogue for xWalkGpio."""
...
MODULE_SOURCE_PREFIX = "xWalkHal/interface/xWalkGpio/"
...
def generateConfiguration(input_path: Path, output_path: Path) -> int:
    ...
    if trace_count == 0:
        raise RuntimeError("The trace inventory contains no xWalkGpio traces")
...
def main() -> int:
    ...
    print(f"Validated {trace_count} persistent xWalkGpio trace(s)")
    return 0

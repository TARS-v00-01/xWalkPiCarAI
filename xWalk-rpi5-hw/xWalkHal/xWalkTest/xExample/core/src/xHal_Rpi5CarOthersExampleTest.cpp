/******************************************************************************
 * @file        xHal_Rpi5CarOthersExampleTest.cpp
 * @brief       Verifies generic-provider chat without credentials or network.
 *
 * @details
...
/**
 * @brief Runs the host-safe generic-provider text example verification.
 * @return Zero after every assertion passes.
 */
int xWalkOthersExampleHostTest()
{
    testConversation();
    testValidation();
    return 0;

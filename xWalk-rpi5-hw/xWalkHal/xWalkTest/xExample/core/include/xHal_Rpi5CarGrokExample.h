/******************************************************************************
 * @file        xHal_Rpi5CarGrokExample.h
 * @brief       Declares the bounded interactive Grok example flow.
 *
 * @details
...
#ifndef XHAL_RPI5CAR_GROK_EXAMPLE_H
#define XHAL_RPI5CAR_GROK_EXAMPLE_H
...
#define XHAL_RPI5CAR_GROK_EXAMPLE_MAXIMUM_PROMPTS 100U
...
namespace xwalk::hal::example
{
     ...
     */
    using grokexamplereadcallback = boolean (*)(contextpointer context, string& inputText);
     ...
     */
    using grokexamplewritecallback = void (*)(contextpointer context,
                                              stringview text,
    ...
    /** @brief Complete injected console table required by the Grok example. */
    struct XWalkGrokExampleCallbacks
    {
            /** @brief Prints the prompt and reads one input line. */
            grokexamplereadcallback readPrompt{nullptr};
            /** @brief Writes welcome text and model responses. */
            grokexamplewritecallback write{nullptr};
    };
    ...
    /** @brief Runs a bounded provider-neutral version of the Grok chat example. */
    class XWalkGrokExample final
    {
        private:
            ...
            XWalkGrokExampleCallbacks callbacks;
        ...
        public:
             ...
             */
            XWalkGrokExample(XWalkLanguageModel& languageModel,
                             contextpointer context,
                             const XWalkGrokExampleCallbacks& consoleCallbacks);

            /** @brief Prevents copying of non-owning dependency bindings. */
            XWalkGrokExample(const XWalkGrokExample&) = delete;
            /** @brief Prevents moving of non-owning dependency bindings. */
            XWalkGrokExample(XWalkGrokExample&&) = delete;
            /** @brief Prevents copy assignment of non-owning dependency bindings. */
            XWalkGrokExample& operator=(const XWalkGrokExample&) = delete;
            /** @brief Prevents move assignment of non-owning dependency bindings. */
            XWalkGrokExample& operator=(XWalkGrokExample&&) = delete;
...
#endif /* XHAL_RPI5CAR_GROK_EXAMPLE_H */

/******************************************************************************
 * @file        xHal_Rpi5CarOthersExampleTestTypes.h
 * @brief       Declares translation-unit support types.
 *
 * @details
 * Owns class and structure declarations used by xHal_Rpi5CarOthersExampleTest.cpp.
 *
...
#ifndef XHAL_RPI5CAROTHERSEXAMPLETESTTYPES_H
#define XHAL_RPI5CAROTHERSEXAMPLETESTTYPES_H
...
/**
 * @namespace xwalk::source_types::xhal_rpi5carothersexampletest
...
#endif /* XHAL_RPI5CAROTHERSEXAMPLETESTTYPES_H */

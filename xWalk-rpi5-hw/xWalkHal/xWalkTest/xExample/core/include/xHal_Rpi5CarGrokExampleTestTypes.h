/******************************************************************************
 * @file        xHal_Rpi5CarGrokExampleTestTypes.h
 * @brief       Declares translation-unit support types.
 *
 * @details
 * Owns class and structure declarations used by xHal_Rpi5CarGrokExampleTest.cpp.
 *
...
#ifndef XHAL_RPI5CARGROKEXAMPLETESTTYPES_H
#define XHAL_RPI5CARGROKEXAMPLETESTTYPES_H
...
/**
 * @namespace xwalk::source_types::xhal_rpi5cargrokexampletest
...
namespace xwalk::source_types::xhal_rpi5cargrokexampletest
{
    ...
    struct GrokExampleState
    {
            ...
            XWalkHal::stringvector responses{"Hello from Grok", "I am ready"};
...
#endif /* XHAL_RPI5CARGROKEXAMPLETESTTYPES_H */

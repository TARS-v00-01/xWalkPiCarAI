/******************************************************************************
 * @file        xHal_Rpi5CarQwenExampleTestTypes.h
 * @brief       Declares translation-unit support types.
 *
 * @details
 * Owns class and structure declarations used by xHal_Rpi5CarQwenExampleTest.cpp.
 *
...
#ifndef XHAL_RPI5CARQWENEXAMPLETESTTYPES_H
#define XHAL_RPI5CARQWENEXAMPLETESTTYPES_H
...
/**
 * @namespace xwalk::source_types::xhal_rpi5carqwenexampletest
...
namespace xwalk::source_types::xhal_rpi5carqwenexampletest
{
    ...
    /** @brief Records Qwen model and console operations from one example run. */
    struct QwenExampleState
    {
            ...
            XWalkHal::stringvector responses{"Hello from Qwen", "I am ready"};
...
#endif /* XHAL_RPI5CARQWENEXAMPLETESTTYPES_H */

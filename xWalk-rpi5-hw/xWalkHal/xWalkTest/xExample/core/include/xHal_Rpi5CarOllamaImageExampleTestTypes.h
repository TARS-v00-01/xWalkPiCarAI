/******************************************************************************
 * @file        xHal_Rpi5CarOllamaImageExampleTestTypes.h
 * @brief       Declares translation-unit support types.
 *
 * @details
 * Owns class and structure declarations used by xHal_Rpi5CarOllamaImageExampleTest.cpp.
 *
...
#ifndef XHAL_RPI5CAROLLAMAIMAGEEXAMPLETESTTYPES_H
#define XHAL_RPI5CAROLLAMAIMAGEEXAMPLETESTTYPES_H
...
/**
 * @namespace xwalk::source_types::xhal_rpi5carollamaimageexampletest
...
#endif /* XHAL_RPI5CAROLLAMAIMAGEEXAMPLETESTTYPES_H */

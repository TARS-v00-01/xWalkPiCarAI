/******************************************************************************
 * @file        xHal_Rpi5CarOllamaExampleTestTypes.h
 * @brief       Declares translation-unit support types.
 *
 * @details
 * Owns class and structure declarations used by xHal_Rpi5CarOllamaExampleTest.cpp.
 *
...
#ifndef XHAL_RPI5CAROLLAMAEXAMPLETESTTYPES_H
#define XHAL_RPI5CAROLLAMAEXAMPLETESTTYPES_H
...
/**
 * @namespace xwalk::source_types::xhal_rpi5carollamaexampletest
...
namespace xwalk::source_types::xhal_rpi5carollamaexampletest
{
    ...
    struct OllamaExampleState
    {
            ...
            XWalkHal::stringvector responses{"Hello from Ollama", "I am ready"};
...
#endif /* XHAL_RPI5CAROLLAMAEXAMPLETESTTYPES_H */

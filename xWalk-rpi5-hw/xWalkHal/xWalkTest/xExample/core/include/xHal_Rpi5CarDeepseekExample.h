/******************************************************************************
 * @file        xHal_Rpi5CarDeepseekExample.h
 * @brief       Declares the bounded interactive DeepSeek example flow.
 *
 * @details
...
#ifndef XHAL_RPI5CAR_DEEPSEEK_EXAMPLE_H
#define XHAL_RPI5CAR_DEEPSEEK_EXAMPLE_H
...
#define XHAL_RPI5CAR_DEEPSEEK_EXAMPLE_MAXIMUM_PROMPTS 100U
...
namespace xwalk::hal::example
{
     ...
     */
    using deepseekexamplereadcallback = boolean (*)(contextpointer context, string& inputText);
     ...
     */
    using deepseekexamplewritecallback = void (*)(contextpointer context,
                                                  stringview text,
    ...
    /** @brief Complete injected console table required by the DeepSeek example. */
    struct XWalkDeepseekExampleCallbacks
    {
            /** @brief Prints the prompt and reads one input line. */
            deepseekexamplereadcallback readPrompt{nullptr};
            /** @brief Writes welcome text and model responses. */
            deepseekexamplewritecallback write{nullptr};
    };
    ...
    /** @brief Runs a bounded provider-neutral version of the DeepSeek chat example. */
    class XWalkDeepseekExample
    {
        private:
            ...
            XWalkDeepseekExampleCallbacks callbacks;
        ...
        public:
             ...
             */
            XWalkDeepseekExample(XWalkLanguageModel& languageModel,
                                 contextpointer context,
                                 const XWalkDeepseekExampleCallbacks& consoleCallbacks);

            /** @brief Prevents copying of non-owning dependency bindings. */
            XWalkDeepseekExample(const XWalkDeepseekExample&) = delete;
            /** @brief Prevents moving of non-owning dependency bindings. */
            XWalkDeepseekExample(XWalkDeepseekExample&&) = delete;
            /** @brief Prevents copy assignment of non-owning dependency bindings. */
            XWalkDeepseekExample& operator=(const XWalkDeepseekExample&) = delete;
            /** @brief Prevents move assignment of non-owning dependency bindings. */
            XWalkDeepseekExample& operator=(XWalkDeepseekExample&&) = delete;
...
#endif /* XHAL_RPI5CAR_DEEPSEEK_EXAMPLE_H */

...
namespace xwalk::hal::example
{
     ...
     */
    using ttspiperspeakcallback = void (*)(contextpointer context, stringview model, stringview text);
    ...
    class XWalkTtsPiperExample final
    {
        ...
        public:
             ...
             */
            XWalkTtsPiperExample(contextpointer context, ttspiperspeakcallback speak);
            ...
            XWalkTtsPiperExample& operator=(const XWalkTtsPiperExample&) = delete;

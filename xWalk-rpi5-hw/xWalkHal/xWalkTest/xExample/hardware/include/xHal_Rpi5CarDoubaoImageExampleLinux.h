/******************************************************************************
 * @file        xHal_Rpi5CarDoubaoImageExampleLinux.h
 * @brief       Declares camera, console, and HTTPS Doubao composition.
 *
...
#ifndef XHAL_RPI5CAR_DOUBAO_IMAGE_EXAMPLE_LINUX_H
#define XHAL_RPI5CAR_DOUBAO_IMAGE_EXAMPLE_LINUX_H
...
namespace xwalk::hal::example
{
    ...
    /** @brief Composes Doubao image chat with Linux camera and terminal adapters. */
    class XWalkDoubaoImageExampleLinux final
    {
        protected:
        ...
        public:
            /**
             * @brief Runs bounded camera chat through the Doubao API.
...
#endif /* XHAL_RPI5CAR_DOUBAO_IMAGE_EXAMPLE_LINUX_H */

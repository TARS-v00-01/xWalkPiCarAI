/******************************************************************************
 * @file        xHal_Rpi5CarGeminiExampleLinux.h
 * @brief       Declares console and HTTPS composition for the Gemini example.
 *
...
#ifndef XHAL_RPI5CAR_GEMINI_EXAMPLE_LINUX_H
#define XHAL_RPI5CAR_GEMINI_EXAMPLE_LINUX_H
...
namespace xwalk::hal::example
{
    ...
    /** @brief Composes the Gemini example with libcurl and terminal input/output. */
    class XWalkGeminiExampleLinux final
    {
        protected:
        ...
        public:
            /**
             * @brief Runs bounded interactive chat through the Gemini API.
...
#endif /* XHAL_RPI5CAR_GEMINI_EXAMPLE_LINUX_H */

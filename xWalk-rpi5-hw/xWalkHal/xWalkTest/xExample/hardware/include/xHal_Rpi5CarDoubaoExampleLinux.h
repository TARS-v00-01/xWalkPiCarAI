/******************************************************************************
 * @file        xHal_Rpi5CarDoubaoExampleLinux.h
 * @brief       Declares console and HTTPS composition for the Doubao example.
 *
...
#ifndef XHAL_RPI5CAR_DOUBAO_EXAMPLE_LINUX_H
#define XHAL_RPI5CAR_DOUBAO_EXAMPLE_LINUX_H
...
namespace xwalk::hal::example
{
    ...
    /** @brief Composes the Doubao example with libcurl and terminal input/output. */
    class XWalkDoubaoExampleLinux final
    {
        protected:
        ...
        public:
            /**
             * @brief Runs bounded interactive chat through the Doubao API.
...
#endif /* XHAL_RPI5CAR_DOUBAO_EXAMPLE_LINUX_H */

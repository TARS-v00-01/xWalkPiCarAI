/******************************************************************************
 * @file        xHal_Rpi5CarQwenExampleLinux.h
 * @brief       Declares console and HTTPS composition for the Qwen example.
 *
...
#ifndef XHAL_RPI5CAR_QWEN_EXAMPLE_LINUX_H
#define XHAL_RPI5CAR_QWEN_EXAMPLE_LINUX_H
...
namespace xwalk::hal::example
{
    ...
    /** @brief Composes the Qwen example with libcurl and terminal input/output. */
    class XWalkQwenExampleLinux final
    {
        protected:
        ...
        public:
            /**
             * @brief Runs bounded interactive chat through the Qwen API.
...
#endif /* XHAL_RPI5CAR_QWEN_EXAMPLE_LINUX_H */

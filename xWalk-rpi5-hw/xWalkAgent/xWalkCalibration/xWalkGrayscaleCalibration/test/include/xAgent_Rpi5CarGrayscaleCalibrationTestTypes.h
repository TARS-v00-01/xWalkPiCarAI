/******************************************************************************
 * @file        xAgent_Rpi5CarGrayscaleCalibrationTestTypes.h
 * @brief       Declares translation-unit support types.
 *
 * @details
 * Owns class and structure declarations used by xAgent_Rpi5CarGrayscaleCalibrationTest.cpp.
 *
...
#ifndef XAGENT_RPI5CARGRAYSCALECALIBRATIONTESTTYPES_H
#define XAGENT_RPI5CARGRAYSCALECALIBRATIONTESTTYPES_H
...
/**
 * @namespace xwalk::source_types::xagent_rpi5cargrayscalecalibrationtest
...
namespace xwalk::source_types::xagent_rpi5cargrayscalecalibrationtest
{
    ...
    /** @brief Provides one constant 1000-count ADC sample. */
    struct TestBus
    {
    ...
    /** @brief Records injected delays and bounds continuation queries. */
    struct TestSchedule
    {
            agent::uint32vector delays{};
            agent::uint32 queryCount{};
            agent::uint32 queryLimit{1'000U};
    };

} /* namespace xwalk::source_types::xagent_rpi5cargrayscalecalibrationtest */

#endif /* XAGENT_RPI5CARGRAYSCALECALIBRATIONTESTTYPES_H */

...
#include <cassert>
#include "xAgent_Rpi5CarMoveExampleTestTypes.h"

/******************************************************************************
 * Translation-unit type aliases
 ******************************************************************************/

using TestBus = ::xwalk::source_types::xagent_rpi5carmoveexampletest::TestBus;
using TestGpio = ::xwalk::source_types::xagent_rpi5carmoveexampletest::TestGpio;
using TestSchedule = ::xwalk::source_types::xagent_rpi5carmoveexampletest::TestSchedule;
...
namespace
{
    ...
    void testMoveExample(agent::stringview configurationPath)
    {
        ...
        xwalk::agent::XWalkMoveExample example(picarx, &schedule, &delay, &continueOperation);

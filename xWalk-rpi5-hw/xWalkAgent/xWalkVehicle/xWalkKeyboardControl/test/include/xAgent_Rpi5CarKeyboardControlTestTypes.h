/******************************************************************************
 * @file        xAgent_Rpi5CarKeyboardControlTestTypes.h
 * @brief       Declares translation-unit support types.
 *
 * @details
 * Owns class and structure declarations used by xAgent_Rpi5CarKeyboardControlTest.cpp.
 *
...
#ifndef XAGENT_RPI5CARKEYBOARDCONTROLTESTTYPES_H
#define XAGENT_RPI5CARKEYBOARDCONTROLTESTTYPES_H
...
/**
 * @namespace xwalk::source_types::xagent_rpi5carkeyboardcontroltest
...
#endif /* XAGENT_RPI5CARKEYBOARDCONTROLTESTTYPES_H */

/******************************************************************************
 * @file        xAgent_Rpi5CarObstacleAvoidanceTestTypes.h
 * @brief       Declares translation-unit support types.
 *
 * @details
 * Owns class and structure declarations used by xAgent_Rpi5CarObstacleAvoidanceTest.cpp.
 *
...
#ifndef XAGENT_RPI5CAROBSTACLEAVOIDANCETESTTYPES_H
#define XAGENT_RPI5CAROBSTACLEAVOIDANCETESTTYPES_H
...
/**
 * @namespace xwalk::source_types::xagent_rpi5carobstacleavoidancetest
...
#endif /* XAGENT_RPI5CAROBSTACLEAVOIDANCETESTTYPES_H */

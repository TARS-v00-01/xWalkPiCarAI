...
export XWALK_GERRIT_COMPONENT_REPOSITORIES="devloper-note xWalkDriver xWalkAudioResources xWalkController xWalkHal xWalk-rpi5-iw xWalk-rpi5-node xWalkLibrary xWalk-rpi5-tool xWalk-rpi5-trace"
export GERRIT_VERIFICATION_TARGETS="${GERRIT_VERIFICATION_TARGETS:-xWalkPiCarAI:master,devloper-note:master,xWalkDriver:master,xWalkAudioResources:master,xWalkController:master,xWalkHal:master,xWalk-rpi5-iw:master,xWalk-rpi5-node:master,xWalkLibrary:master,xWalk-rpi5-tool:master,xWalk-rpi5-trace:master}"
